...
class Student(object):
    ...
    def evaluate_score(self, haveBonus=False):
...
if stuID:
    ...
    print(stu)
    print('Finish autoGrading, Your Score is %.2f (Pass %i/%i questions) ' %
          (stu.evaluate_score(haveBonus=True), stu.num_questions_pass, stu.num_questions_total))
